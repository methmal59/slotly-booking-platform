...
1. **1,701+ deterministic tests** with the LLM faked — units, full conversation-flow simulations, and five hardening tiers (silent failures, messy multi-intent conversations, weird inputs, odd configs, failure injection).
...
* [`EVALS.md`](EVALS.md) — how you test an LLM system: 1,701+ deterministic tests plus a nightly real-model eval suite with a regression gate
